CLASS zcl_22ad039_sales_util DEFINITION
  PUBLIC
  FINAL
  CREATE PRIVATE.
...
zcl_22ad039_sales_util.

    METHODS :
      set_hdr_value         IMPORTING im_sales_hdr TYPE z22ad039_vbak
                            EXPORTING ex_created   TYPE abap_boolean,
      get_hdr_value         EXPORTING ex_sales_hdr TYPE z22ad039_vbak,

      set_itm_value         IMPORTING im_sales_itm TYPE z22ad039_vbap
                            EXPORTING ex_created   TYPE abap_boolean,
      get_itm_value         EXPORTING ex_sales_itm TYPE z22ad039_vbap,
  ...
  PRIVATE SECTION.
    CLASS-DATA : gs_sales_hdr_buff   TYPE z22ad039_vbak,
                 gs_sales_itm_buff   TYPE z22ad039_vbap,
                 gt_sales_hdr_t_buff TYPE tt_sales_hdr,
                 gt_sales_itm_t_buff TYPE tt_sales_item,
                 gv_so_delete        TYPE abap_boolean,
                 mo_instance         TYPE REF TO zcl_22ad039_sales_util.
ENDCLASS.



CLASS ZCL_22AD039_SALES_UTIL IMPLEMENTATION.
